...
CFLAGS   = -fPIC -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -D_FORTIFY_SOURCE=2 -fPIC $(ARCH_FLAG)
...
pre-install-rb-default:
	$(ECHO) installing default carray libraries
$(RUBYARCHDIR):
	$(Q) $(MAKEDIRS) $@
